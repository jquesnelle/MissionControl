...
eARCONTROLLER_DICTIONARY_KEY ARCONTROLLER_DICTIONARY_Key_GetFeatureFromCommandKey (eARCONTROLLER_DICTIONARY_KEY commandKey)
{
    ...
    else if (ARCONTROLLER_DICTIONARY_KEY_ARDRONE3DEBUG <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_COMMON)
    {
    ...
    else if (ARCONTROLLER_DICTIONARY_KEY_COMMONDEBUG <= commandKey && commandKey < ARCONTROLLER_DICTIONARY_KEY_JUMPINGSUMO)
    {
