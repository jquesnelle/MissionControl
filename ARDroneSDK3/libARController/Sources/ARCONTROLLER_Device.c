...
ARCONTROLLER_Device_t *ARCONTROLLER_Device_New (ARDISCOVERY_Device_t *discoveryDevice, eARCONTROLLER_ERROR *error)
{
    ...
    if (localError == ARCONTROLLER_OK)
    {
        dicoveryError = ARDISCOVERY_Device_InitNetworkCongifuration (deviceController->privatePart->discoveryDevice, &(deviceController->privatePart->networkConfiguration));
        if (dicoveryError != ARDISCOVERY_OK)
        {
...
eARCONTROLLER_ERROR ARCONTROLLER_Device_RegisterCallbacks (ARCONTROLLER_Device_t *deviceController)
{
    ...
    if (deviceController->common != NULL)
    {
        ...
        if (error == ARCONTROLLER_OK)
        {
            error = ARCONTROLLER_FEATURE_Common_AddCallback (deviceController->common, ARCONTROLLER_DICTIONARY_KEY_COMMON_CONTROLLERSTATE_ISPILOTINGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
        }
...
eARCONTROLLER_ERROR ARCONTROLLER_Device_UnregisterCallbacks (ARCONTROLLER_Device_t *deviceController)
{
    ...
    if (error == ARCONTROLLER_OK)
    {
        ...
        if (deviceController->common != NULL)
        {
            ...
            removingError = ARCONTROLLER_FEATURE_Common_RemoveCallback (deviceController->common, ARCONTROLLER_DICTIONARY_KEY_COMMON_CONTROLLERSTATE_ISPILOTINGCHANGED, ARCONTROLLER_Device_DictionaryChangedCallback, deviceController);
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring removing of the callback for ARCONTROLLER_DICTIONARY_KEY_COMMON_CONTROLLERSTATE_ISPILOTINGCHANGED; error :%s", ARCONTROLLER_Error_ToString (removingError));
            }
...
eARCONTROLLER_ERROR ARCONTROLLER_Device_SetNetworkControllerToFeatures (ARCONTROLLER_Device_t *deviceController)
{
    ...
    if (error == ARCONTROLLER_OK)
    {
        if (deviceController->aRDrone3 != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_ARDRONE3_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->aRDrone3Debug != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_ARDRONE3DEBUG_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->common != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_COMMON_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->commonDebug != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_COMMONDEBUG_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->jumpingSumo != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_JUMPINGSUMO_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->jumpingSumoDebug != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_JUMPINGSUMODEBUG_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->miniDrone != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_MINIDRONE_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->miniDroneDebug != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_MINIDRONEDEBUG_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->skyController != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLER_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
        ...
        if (deviceController->skyControllerDebug != NULL)
        {
            ...
            if (error != ARCONTROLLER_OK)
            {
                ARSAL_PRINT(ARSAL_PRINT_ERROR, ARCONTROLLER_DEVICE_TAG, "Error occured durring setting the network Controller to the feature of the callback for ARCONTROLLER_DICTIONARY_KEY_SKYCONTROLLERDEBUG_DEBUG_MAGNETOCALIBRATIONQUALITYUPDATESSTATE; error :%s", ARCONTROLLER_Error_ToString (settingError));
            }
