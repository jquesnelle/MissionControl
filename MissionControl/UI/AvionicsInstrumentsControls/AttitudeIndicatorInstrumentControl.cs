...
namespace MissionControl.UI.AvionicsInstrumentsControls
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
