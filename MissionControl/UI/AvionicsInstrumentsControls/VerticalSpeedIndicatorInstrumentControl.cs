...
namespace MissionControl.UI.AvionicsInstrumentsControls
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.VerticalSpeedNeedle);
